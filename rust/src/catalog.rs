...
fn xmeas_meta() -> Vec<MeasMeta> {
    [
        ...
        (4, "A and C Feed (stream 4)", "A/C 进料（物流 4）", "kscmh", "流量"),
        (5, "Recycle Flow (stream 8)", "循环流量（物流 8）", "kscmh", "流量"),
        (6, "Reactor Feed Rate (stream 6)", "反应器进料（物流 6）", "kscmh", "反应器"),
        (7, "Reactor Pressure", "反应器压力", "kPa gauge", "反应器"),
        (8, "Reactor Level", "反应器液位", "%", "反应器"),
        (9, "Reactor Temperature", "反应器温度", "°C", "反应器"),
        (10, "Purge Rate (stream 9)", "放空流量（物流 9）", "kscmh", "流量"),
        (11, "Product Sep Temp", "分离器温度", "°C", "分离器"),
        (12, "Product Sep Level", "分离器液位", "%", "分离器"),
        (13, "Prod Sep Pressure", "分离器压力", "kPa gauge", "分离器"),
        (14, "Prod Sep Underflow (stream 10)", "分离器釜液（物流 10）", "m³/h", "分离器"),
        (15, "Stripper Level", "汽提塔液位", "%", "汽提塔"),
        (16, "Stripper Pressure", "汽提塔压力", "kPa gauge", "汽提塔"),
        (17, "Stripper Underflow (stream 11)", "产品流量（物流 11）", "m³/h", "汽提塔"),
        (18, "Stripper Temperature", "汽提塔温度", "°C", "汽提塔"),
        (19, "Stripper Steam Flow", "汽提蒸汽流量", "kg/h", "汽提塔"),
        (20, "Compressor Work", "压缩机功率", "kW", "压缩机"),
        (21, "Reactor Cooling Water Outlet Temp", "反应器冷却水出口温度", "°C", "反应器"),
        (22, "Separator Cooling Water Outlet Temp", "冷凝器冷却水出口温度", "°C", "分离器"),
        (23, "Component A (stream 6)", "组分 A（物流 6）", "mol %", "成分·进料"),
        (24, "Component B (stream 6)", "组分 B（物流 6）", "mol %", "成分·进料"),
        (25, "Component C (stream 6)", "组分 C（物流 6）", "mol %", "成分·进料"),
        (26, "Component D (stream 6)", "组分 D（物流 6）", "mol %", "成分·进料"),
        (27, "Component E (stream 6)", "组分 E（物流 6）", "mol %", "成分·进料"),
        (28, "Component F (stream 6)", "组分 F（物流 6）", "mol %", "成分·进料"),
        (29, "Component A (stream 9)", "组分 A（物流 9）", "mol %", "成分·放空"),
        (30, "Component B (stream 9)", "组分 B（物流 9）", "mol %", "成分·放空"),
        (31, "Component C (stream 9)", "组分 C（物流 9）", "mol %", "成分·放空"),
        (32, "Component D (stream 9)", "组分 D（物流 9）", "mol %", "成分·放空"),
        (33, "Component E (stream 9)", "组分 E（物流 9）", "mol %", "成分·放空"),
        (34, "Component F (stream 9)", "组分 F（物流 9）", "mol %", "成分·放空"),
        (35, "Component G (stream 9)", "组分 G（物流 9）", "mol %", "成分·放空"),
        (36, "Component H (stream 9)", "组分 H（物流 9）", "mol %", "成分·放空"),
        (37, "Component D (stream 11)", "组分 D（物流 11）", "mol %", "成分·产品"),
        (38, "Component E (stream 11)", "组分 E（物流 11）", "mol %", "成分·产品"),
        (39, "Component F (stream 11)", "组分 F（物流 11）", "mol %", "成分·产品"),
        (40, "Component G (stream 11)", "组分 G（物流 11）", "mol %", "成分·产品"),
        (41, "Component H (stream 11)", "组分 H（物流 11）", "mol %", "成分·产品"),
    ]
    .into_iter()
...
fn xmv_meta() -> Vec<MvMeta> {
    [
        ...
        (7, "Separator Pot Liquid Flow (stream 10)", "分离器釜液阀（物流 10）"),
        (8, "Stripper Liquid Product Flow (stream 11)", "产品阀（物流 11）"),
